...
class CrearEmpleado(UserCreationForm):
    ...
    first_name = forms.CharField(widget=forms.TextInput(attrs={'help_texts':None}), label= 'Nombres')
    last_name = forms.CharField(widget=forms.TextInput(attrs={'help_texts':None}), label= 'Apellidos')
    email = forms.CharField(widget=forms.TextInput(attrs={'help_texts':None}), label= 'Correo Electronico')
    class Meta:
        model = User
